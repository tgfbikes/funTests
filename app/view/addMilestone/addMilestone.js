(function () {
	...
	angular
		.module('int1')
		.factory("addMilestone", addMilestone)
		.controller('AddMilestoneCtrl', AddMilestoneCtrl);

	AddMilestoneCtrl.$inject = ['$scope', 'milestoneService'];

	function addMilestone ($rootScope, $uibModal) {
	...
	function AddMilestoneCtrl ($scope, milestoneService, $uibModalInstance) {
		var vm = this;
